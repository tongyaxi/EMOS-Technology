...
@RestController
@RequestMapping("/reim")
@Tag(name = "ReimController", description = "立替金WebAPI")
public class ReimController {

    @Autowired
    private ReimService reimService;

    @Operation(summary = "立替金のページデータを検索する")
    ...
    @Operation(summary = "立替金情報をIDで検索する")
