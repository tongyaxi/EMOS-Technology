        ...
        <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
            <div class="site-navbar__header">
                <h1 class="site-navbar__brand">
                    <a class="site-navbar__brand-lg">Emos Work System</a>
                ...
                <el-menu class="site-navbar__menu site-navbar__menu--right" mode="horizontal">
                    ...
                    <el-menu-item class="site-navbar__avatar" index="3">
                        <el-dropdown>
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    <el-dropdown-item @click="updatePasswordHandle()">パスワード変更</el-dropdown-item>
            ...
            <div class="site-sidebar__inner">
                ...
                >
                    <el-menu-item index="home" @click="$router.push({ name: 'Home' })">
                        ...
                        <span slot="title">ホームページ</span>
                    </el-menu-item>
                    <el-submenu index="組織マネジメント" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
                        <template #title>
                            <SvgIcon name="users_fill" class="icon-svg" />
                            <span slot="title">組織マネジメント</span>
                        </template>
                        <el-menu-item
                            index="dept"
                    ...
                    <el-submenu index="在线办公" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
                        <template #title>
                            ...
                            <span slot="title">オンラインオフィス</span>
                        </template>
                        <el-menu-item
                            index="approval"
...
export default {
    // 1.引入2.注册
    components: { SvgIcon, UpdatePassword, UpdatePassword },
    data: function() {
        return {
            navbarLayoutType: '',
            sidebarFold: false,
    ...
    created() {
		...
		// 当websocket连接创建成功后，会触发这个回调函数运行
        _this.$options.sockets.onopen = function(resp) {
            //发送心跳检测，避免超时后服务端切断连接
            setInterval(function() {
                _this.$socket.sendObj({ opt: 'ping' });
            }, 60 * 1000);
        };
    },
    watch: {
    ...
    methods: {
		...
		logout: function() {
			let _this = this;
			_this.$http('user/logout', 'GET', null, true, function(response){
				// 删除权限
    ...
    mounted: function() {
        let _this = this;
        //加载用户数据
        _this.$http('user/loadUserInfo', 'GET', null, true, function(resp) {
            let json = resp;
            let name = json.name;
        ...
        _this.loadSiteContentViewHeight();
    }
};
</script>
