<template>
	<div>
		...
		>
			...
			<el-table-column prop="type" header-align="center" align="center" label="报销类型" />
			<el-table-column prop="name" header-align="center" align="center" label="申请人" />
			<el-table-column prop="deptName" header-align="center" align="center" label="所属部门" />
			<el-table-column header-align="center" align="center" label="报销金额">
				<template #default="scope">
					<span>{{ scope.row.amount }}元</span>
				</template>
			</el-table-column>
			<el-table-column header-align="center" align="center" label="借款金额">
				<template #default="scope">
					<span>{{ scope.row.anleihen }}元</span>
				</template>
			</el-table-column>
			<el-table-column header-align="center" align="center" label="实际报销">
				<template #default="scope">
					<span>{{ scope.row.balance }}元</span>
				</template>
			</el-table-column>
			<el-table-column prop="status" header-align="center" align="center" label="状态" />
			<el-table-column prop="createTime" header-align="center" align="center" label="申请日期" />
	...
	methods: {
		...
		loadDataList: function() {
			...
			that.$http('reim/searchReimByPage', 'POST', data, true, function(resp) {
				let page = resp.page;
				let status = { 1: '待审批', 2: '已否决', 3: '已通过', 4: '已归档' };
